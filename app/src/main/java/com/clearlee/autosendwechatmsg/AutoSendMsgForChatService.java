...
//                }
    ...
    private void handleFlow_ChatUI() {
        ...
        String curUserName = WechatUtils.findTextById(this, WeChatTextWrapper.WechatId70.WECHATID_CHATUI_USERNAME_ID);
        if (!TextUtils.isEmpty(curUserName) && curUserName.equals(WechatUtils.NAME)) {
            if (WechatUtils.findViewByIdAndPasteContent(this, WeChatTextWrapper.WechatId70.WECHATID_CHATUI_EDITTEXT_ID, WechatUtils.CONTENT)) {
                sendContent();
            } else {
                //当前页面可能处于发送语音状态，需要切换成发送文本状态
                WechatUtils.findViewIdAndClick(this, WeChatTextWrapper.WechatId70.WECHATID_CHATUI_SWITCH_ID);
            ...
            //回到主界面
            WechatUtils.findViewIdAndClick(this, WeChatTextWrapper.WechatId70.WECHATID_CHATUI_BACK_ID);
        }
    }
